...
class PropertyCurrent(models.Model):
    ...
    bathrooms_full = models.DecimalField(decimal_places=4, max_digits=10, default=0, null=True, blank=True)
    bedrooms_half = models.DecimalField(decimal_places=2, max_digits=5, default=0, null=True, blank=True)
    bathrooms_half = models.DecimalField(decimal_places=4, max_digits=10, default=0, null=True, blank=True)
    bedroom_dimensions_all = models.CharField(max_length=255, null=True, blank=True)
    ...
    living_room_dimensions = models.CharField(max_length=255, null=True, blank=True) 
    living_room_flooring = models.CharField(max_length=255, null=True, blank=True) 
    living_room_level = models.CharField(max_length=255, null=True, blank=True) 
    attic_info = models.CharField(max_length=512, null=True, blank=True)
    basement_info = models.CharField(max_length=512, null=True, blank=True)    
    heating_info = models.CharField(max_length=512, null=True, blank=True)       
    cooling_info = models.CharField(max_length=512, null=True, blank=True)       
    garage_info = models.CharField(max_length=512, null=True, blank=True)       
    fireplace_info = models.CharField(max_length=512, null=True, blank=True)   
    exterior_features = models.TextField(null=True, blank=True)
    roof_info = models.CharField(max_length=512, null=True, blank=True) 
    foundation_info = models.CharField(max_length=512, null=True, blank=True) 
    lot_dimensions = models.CharField(max_length=256, null=True, blank=True) 
    lot_description = models.CharField(max_length=512, null=True, blank=True) 
    school_elementary = models.CharField(max_length=256, null=True, blank=True)
    school_middle = models.CharField(max_length=256, null=True, blank=True)
    school_high = models.CharField(max_length=256, null=True, blank=True)
